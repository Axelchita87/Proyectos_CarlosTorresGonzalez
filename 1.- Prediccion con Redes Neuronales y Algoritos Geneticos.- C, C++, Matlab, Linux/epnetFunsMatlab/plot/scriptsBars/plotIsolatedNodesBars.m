...
if  size( infoBar.avFitness, 2 ) > 1
    ...
    if strcmp(typePlot, 'AV')
        hold off;
        h = bar(xVals, infoBar.avIsolated);
        set(gca,'XTickLabel',xTicksL);
    elseif strcmp(typePlot, 'STD')
        h = errorb(infoBar.avIsolated,infoBar.stdIsolated,'top');
        set(gca,'XTickLabel',xTicks);
    elseif strcmp(typePlot, 'STE')
        h = errorb(infoBar.avIsolated,infoBar.steIsolated,'top');
        set(gca,'XTickLabel',xTicks);
    end
    ...
    if strcmp(typePlot, 'AV')
        hold off;
        bar(xVals, infoBar.avIsolated');
        set(gca,'XTickLabel',xTicksL);
    elseif strcmp(typePlot, 'STD')
        bar(xVals, infoBar.avIsolated');
        errorb(infoBar.avIsolated',infoBar.stdIsolated','top');
        set(gca,'XTickLabel',xTicks);
    elseif strcmp(typePlot, 'STE')
        bar(xVals, infoBar.avIsolated');
        errorb(infoBar.avIsolated',infoBar.steIsolated','top');
        set(gca,'XTickLabel',xTicks);
    end
