...
% StestRandomExp4.m
%
% Here is the third version to generate ANN randonly with a more elaborate
% way to initialize them and looking for the module formation.
%
%
...
%
% The name of this experiment is 4 to be saved the results
%
% (Saved::: A,B,...,L ) XXXXX not sure in this moment how many combination
% I will do for this experiment
% 1000 networks are generated to test the results statistically
%
% 
...
Exp = 'resExp4';            % options: 'resExp2' or 'resExp2'
FillMat = 'h';                % options h = $fill~by~line$, v = $fill~by~column$
...
for M = 1:2
    ...
    for repInit = 1:lines               % Exp A,B,...
        ...
        for rep = 1:cols
            ...
            noInp = double( int8(minInp+ (maxInp - minInp) * rand()) );
            noHid = double( int8(minHid+ (maxHid - minHid) * rand()) );
            noOut = double( int8(minOut+ (maxOut - minOut) * rand()) );
            ...
            switch repInit
                case 1
                    probMat = obtainProbMatExp4M(noInp, noHid, noOut, posinputs, hiddenN, outputN,FillMat);
                case 2
                    probMat = obtainProbMatExp4N(noInp, noHid, noOut, posinputs, hiddenN, outputN,FillMat);
                case 3
                    probMat = obtainProbMatExp4O(noInp, noHid, noOut, posinputs, hiddenN, outputN,FillMat);
                case 4
                    probMat = obtainProbMatExp4P(noInp, noHid, noOut, posinputs, hiddenN, outputN,FillMat);
                case 5
                    probMat = obtainProbMatExp4Q(noInp, noHid, noOut, posinputs, hiddenN, outputN,FillMat);
                case 6
                    probMat = obtainProbMatExp4R(noInp, noHid, noOut, posinputs, hiddenN, outputN,FillMat);
                case 7
                    probMat = obtainProbMatExp4S(noInp, noHid, noOut, posinputs, hiddenN, outputN,FillMat);
                case 8
                    probMat = obtainProbMatExp4T(noInp, noHid, noOut, posinputs, hiddenN, outputN,FillMat);
                case 9
                    probMat = obtainProbMatExp4U(noInp, noHid, noOut, posinputs, hiddenN, outputN,FillMat);
                case 10
                    probMat = obtainProbMatExp4V(noInp, noHid, noOut, posinputs, hiddenN, outputN,FillMat);
                case 11
                    probMat = obtainProbMatExp4W(noInp, noHid, noOut, posinputs, hiddenN, outputN,FillMat);
                case 12
                    probMat = obtainProbMatExp4X(noInp, noHid, noOut, posinputs, hiddenN, outputN,FillMat);
