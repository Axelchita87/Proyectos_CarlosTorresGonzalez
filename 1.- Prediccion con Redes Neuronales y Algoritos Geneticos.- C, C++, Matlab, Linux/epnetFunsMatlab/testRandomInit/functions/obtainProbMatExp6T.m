...
function probM = obtainProbMatExp6T(noInp, noHid, noOut, inputs, hidden, outputs,exp)
...
probM = fillMatDiag(probM,inputs,hidden,I2HlineI, I2HlineF,exp);
...
% H2O
%probM = fillMatE(probM,hidden,outputs, 1,'norm');
probM = fillMatE(probM,inputs,hidden, 1,'norm');
