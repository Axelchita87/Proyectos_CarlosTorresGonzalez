...
elseif nargin == 6              % for incorrect classifications
    ...
    if size(TOut,2) > 2
        ...
        % missing for just one module
    end
end



function h = plotClasses1Output(TInp,TOut,stileL, incorrect)
