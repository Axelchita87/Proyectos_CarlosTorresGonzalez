    ...
    <div class="wrapper">
        ...
        <!-- Content Wrapper. Contains page content -->
      	<div class="content-wrapper">
        	...
        	?>
				<form action="" method="POST" enctype="multipart/form-data" id="form-alta" role="form">
					
					<br />
					<div class="box box-primary">
						<div class="box-header"><h4>Datos para foto del imagen</h4></div>
						<div class="box-body">							
							<div class="col-md-10 col-sm-10 col-xs-7">
								...
								<div class="form-group row">
									<label class="col-md-2 col-sm-2 col-xs-2" style="">Encargado</label>
									<div class="col-md-5 col-sm-8 col-xs-12">
										<div class="input-group">
											<span class="input-group-addon"><i class="fa fa-user"></i></span>
	 										<select name="encargado" id="encargado" class="form-control">	 								
												...
												<?php
												global $obj_db;
                        						$consulta2 = "SELECT id_usuario, CONCAT (user_nombre, ' ', apellido_paterno) AS cnombre FROM usuario ORDER BY cnombre ASC";
                        						$result2 = $obj_db->consulta($consulta2);
                        						if($result2!=false){
		                          					foreach($result2 as $fila2){
                          								echo "<option class='text-danger text-center' value ='".$fila2['id_usuario']."'>".$fila2['cnombre']."</option>";
                          							}  
                          						}                      			
                        						?>
											</select>
					...
					<div class="box box-primary">
						...
						<div class="box-body">
							<div class="col-md-12 col-sm-12 col-xs-12">
								<div class="form-group row">
									<label class="col-md-2 col-sm-2 col-xs-2 col-md-offset-2 col-sm-offset-2 col-xs-offset-2" style="">Foto:*</label>
								</div>
								<div class="form-group row">
							...
							<div class="">
								<button type="submit" value="Guardar" name="btn_enviar_foto_auditor" class="btn btn-primary">Guardar</button>
