		...
		contenedor = $('#foto_preview2');  
		 ...
		 $("#cac").on('change',function(){
			...
			if ($("#cac").val()!='0'){
				...
				//$("#tienda_activa").prop('cheked',true);
			}else{
				$("#direccion-cac").html('');
				$("#estado").html('');
				$("#municipio").html('');
       ...
       <!-- Main content -->
        <section class="content"> 
			...
			<form action="index.php?command=modificar_cac" method="POST" enctype="multipart/form-data" style="width:100%" id="form-alta">
						...
						<div class="box-body">
							<div class="col-md-12 col-sm-12 col-xs-12">
								...
								<div class="form-group row">
									...
									<div class="col-md-5 col-sm-8 col-xs-12">
										<input type="checkbox" name="tienda_activa" id="tienda_activa" class="minimal" disabled="">
									</div>
								</div>
					...
					<div class="">
						<button type="submit" value="Modificar" name="btn_modificar_cac" id="btn_modificar_cac" class="btn btn-primary">Modificar</button>
					</div>
...
<script>
	function activo() {
	    $('#tienda_activa').prop('checked', true);
	}
	//activo();
</script>
