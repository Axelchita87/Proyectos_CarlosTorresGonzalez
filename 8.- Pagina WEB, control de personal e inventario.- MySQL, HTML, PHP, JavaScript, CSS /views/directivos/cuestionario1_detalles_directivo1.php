   ...
   $(function () {     
    ...
    //recuperar datos 
                      ...
                      '<div class="col-md-12 col-sm-12 col-xs-12"> '+
                        '<div class="row">'+
                          ...
                          '<label class="col-md-1 col-sm-1 col-xs-1">'+
                            '<a href="index.php?command=modificar_cuestionario1_auditor&id_cuestionario='+obj_campana["id"]+'">Editar</a>'+
                          '</label>'+
                          '<label class="col-md-1 col-sm-1 col-xs-1">'+
          ...
          if (obj_detalles['campana'].length>0){
            for (i=0; i<obj_detalles['campana'].length; i++){ 
              ...
              if (typeof json_campana == 'object'){
                ...
                //var json_campana_nombre = isNaN(json_campana['nombre_campana'])?json_campana['nombre_campana']:get_campana_nombre_lista(json_campana['nombre_campana']);
        ...
        function inic_detalles_cuestionario(){
          var detalles = JSON.parse(r_datos({funcion:'get_detalles_cuestionario'}));
