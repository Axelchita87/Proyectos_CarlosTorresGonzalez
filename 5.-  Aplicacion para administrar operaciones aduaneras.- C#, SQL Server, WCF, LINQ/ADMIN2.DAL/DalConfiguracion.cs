...
{
    public class DalConfiguracion : DALBase
    {
        ...
        public List<EntArea> GetConsultaAreas(EntArea Dobj)
        {
            ...
            DBParameterCollection pcol = ParamConfiguracion.LLenaAreas(Dobj, Comunes.BUSCAR);
        ...
        public List<EntPantalla> GetConsultaPantallas(EntPantalla Dobj, string tipo)
        {
            ...
            DBParameterCollection pcol = ParamConfiguracion.LLenaPantallas(Dobj, Comunes.BUSCAR, tipo);
