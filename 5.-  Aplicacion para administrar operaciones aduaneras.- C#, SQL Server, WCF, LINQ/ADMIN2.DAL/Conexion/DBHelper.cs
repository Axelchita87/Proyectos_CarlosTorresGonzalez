...
/*****************************************************************************
 * DALGeneric DATA ACCESS LAYER generico para SQLServer,MySql y Oracle
 * ---------------- Autor--------------
 * David Santos Martínez
 * México
 * dsantosmtz@outlook.com
 ******************************************************************************/
namespace ADMIN2.DAL
{
    /// <summary>
    /// Clase DBHelper permite executar Objetos Sql para los parámetros especificados en web.config o App.config.
    /// </summary>
    public class DBHelper
    {
        ...
        /// <summary>
        /// opcional defaultConnection 
        /// </summary>
        public DBHelper(string connectionString, int Op)
        {
            _connectionManager = new ConnectionManager(connectionString, Op);
            _commandBuilder = new CommandBuilder();
            _dbAdapterManager = new DataAdapterManager();
        }
        ...
        private DBHelper(string connectionName)
        {
            ...
            _commandBuilder = new CommandBuilder();
            _dbAdapterManager = new DataAdapterManager();
            Configuration.ConnectionName = connectionName;
        }

        /// <summary>
        /// connectionStrings y providername
        /// </summary>
        ...
        /// <summary>
        /// Regresa instancia según el nombre de la conexión
        /// </summary>
        /// <param name="connectionName">nombre de la conexión</param>
        /// <returns>Intancia DBHelper </returns>
        ...
        /// 
        /// </summary>
        /// <param name="connectionString">nombre de la conexión</param>
        /// <param name="providerName">Provider Name</param>
        /// <returns>Intancia DBHelper </returns>
        ...
        public string Database
        {
            get
            {
                string typeName = AssemblyProvider.GetInstance(Provider).GetConnectionType();
                IDbConnection connection = (IDbConnection)AssemblyProvider.GetInstance(Provider).DBProviderAssembly.CreateInstance(typeName);
        ...
        public string Provider
        {
            get
            {
                return _connectionManager.ProviderName;
            }
        }
        ...
        public int ExecuteNonQuery(string commandText, DBParameterCollection paramCollection, IDbTransaction transaction, CommandType commandType)
        {
            int rowsAffected = 0;
            IDbConnection connection = transaction != null ? transaction.Connection : _connectionManager.GetConnection();
            IDbCommand command = _commandBuilder.GetCommand(commandText, connection, paramCollection, commandType, Convert.ToString(_connectionManager.ProviderName));
            command.Transaction = transaction;
        ...
        public DataSet ExecuteDataSet(string commandText, DBParameterCollection paramCollection, CommandType commandType)
        {
            ...
            IDataAdapter adapter = _dbAdapterManager.GetDataAdapter(commandText, connection, paramCollection, commandType,Convert.ToString(_connectionManager.ProviderName));
            try
            {
        ...
        public IDataReader ExecuteDataReader(string commandText, IDbConnection connection, DBParameterCollection paramCollection, CommandType commandType)
        {
            ...
            IDbCommand command = _commandBuilder.GetCommand(commandText, connection, paramCollection, commandType, Provider);
        ...
        /// <param name="commandType">Text/ Stored Procedure</param>
        /// <returns>IDataReader</returns>
        public IDataReader ExecuteDataReader(string commandText, DBParameterCollection paramCollection,IDbConnection connection, IDbTransaction transaction, CommandType commandType)
        {
