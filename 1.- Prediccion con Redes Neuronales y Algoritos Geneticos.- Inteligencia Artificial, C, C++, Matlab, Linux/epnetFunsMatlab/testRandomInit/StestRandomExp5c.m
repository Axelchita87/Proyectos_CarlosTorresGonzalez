...
% and the HH section is used the method b fill a diagonal matrix which has
% shown to be good for this sub-matrix
% 
% To run the first part ofthis exp put minOut and maxOut to 1, 
% in the second part put maxOut to n
%
% Plot it with plot1y5Both('resExp5c');
%
...
%             idxOutput = 1:noOut;
            ...
            %HH
            probMat = fillUpperRightMat(probMat,hiddenN,0.1, 0.5,'h');
