    ...
    for repInit = 1:lines               % Exp A,B,...
        ...
        for rep = 1:cols
            ...
            switch repInit
                ...
                case 1
                    probMat = obtainProbMatExp2A(noInp, noHid, noOut, posinputs, hiddenN, outputN,Exp);
                case 2
                    probMat = obtainProbMatExp2B(noInp, noHid, noOut, posinputs, hiddenN, outputN,Exp);
                case 3
                    probMat = obtainProbMatExp2C(noInp, noHid, noOut, posinputs, hiddenN, outputN,Exp);
                case 4
                    probMat = obtainProbMatExp2D(noInp, noHid, noOut, posinputs, hiddenN, outputN,Exp);
                case 5
                    probMat = obtainProbMatExp2E(noInp, noHid, noOut, posinputs, hiddenN, outputN,Exp);
                case 6
                    probMat = obtainProbMatExp2F(noInp, noHid, noOut, posinputs, hiddenN, outputN,Exp);
                case 7
                    probMat = obtainProbMatExp2G(noInp, noHid, noOut, posinputs, hiddenN, outputN,Exp);
                case 8
                    probMat = obtainProbMatExp2H(noInp, noHid, noOut, posinputs, hiddenN, outputN,Exp);
                case 9
                    probMat = obtainProbMatExp2I(noInp, noHid, noOut, posinputs, hiddenN, outputN,Exp);
                case 10
                    probMat = obtainProbMatExp2J(noInp, noHid, noOut, posinputs, hiddenN, outputN,Exp);
                case 11
                    probMat = obtainProbMatExp2K(noInp, noHid, noOut, posinputs, hiddenN, outputN,Exp);
                case 12
                    probMat = obtainProbMatExp2L(noInp, noHid, noOut, posinputs, hiddenN, outputN,Exp);
