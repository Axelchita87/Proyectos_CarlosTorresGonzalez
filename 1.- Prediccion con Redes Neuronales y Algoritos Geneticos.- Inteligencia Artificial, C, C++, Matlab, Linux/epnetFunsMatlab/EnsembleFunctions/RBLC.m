function ensemble = RBLC(ensemble, var, populationNum, Network, toPredictF, Mean_toPredictF)

%Here is claculate the nre predictions, errors and accuracy form normilized
%data
...
%// FOR 0.05 ////////////////////////////////////////////////////////////
    ...
    [ensemble.SRank_base_LCombination_05.Pred, ensemble.weightsRankBase_05] = ...
        calcWeights_And_Outputs_given_Beta(ensemble.SRank_base_LCombination_05.Pred, ...
        ensemble.weightsRankBase_05, populationNum, beta_05, Network);
    
    %%Calculate the Error and Accuracy
    ensemble.SRank_base_LCombination_05 = NRMSError_Accuracy(ensemble.SRank_base_LCombination_05, ...
        toPredictF, Mean_toPredictF, var);
    
    minimo = 0.05;
    nrmsMin = ensemble.SRank_base_LCombination_05.NRMSE;
