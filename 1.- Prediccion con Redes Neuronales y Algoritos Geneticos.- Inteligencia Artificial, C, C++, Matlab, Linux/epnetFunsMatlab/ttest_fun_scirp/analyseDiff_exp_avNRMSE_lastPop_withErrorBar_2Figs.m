...
% final population. This reuyslts are plotted and compared with the error
% bars.

%THIS SCRITP PLOT ONE OR TWO FIGURES IN THE SAME PLOT
%LINE: 1 AVERAGE BEST FINAL TEST SET 
%LINE: 2 AVERAGE FORM THE LAST POP TEST SET INSIDE epnet 
...
dirExp{1,18} = 'D:\DoctoradoResultados\TSEPnet54C\';
dirExp{1,19} = 'D:\DoctoradoResultados\TSEPnet55C\';
dirExp{1,20} = 'D:\DoctoradoResultados\TSEPnet56C\';
dirExp{1,21} = 'D:\DoctoradoResultados\TSEPnet57Ca\';
dirExp{1,22} = 'D:\DoctoradoResultados\TSEPnet57Cb\';
dirExp{1,23} = 'D:\DoctoradoResultados\TSEPnet57Cc\';
dirExp{1,24} = 'D:\DoctoradoResultados\TSEPnet30C\';
dirExp{1,25} = 'D:\DoctoradoResultados\TSEPnet31C\';
...
TicksX ={};% {' ';'A';'B';'C';'D';'E';'F';'G';'H';'I';'J';'K';'L';'M';'N'; ...
