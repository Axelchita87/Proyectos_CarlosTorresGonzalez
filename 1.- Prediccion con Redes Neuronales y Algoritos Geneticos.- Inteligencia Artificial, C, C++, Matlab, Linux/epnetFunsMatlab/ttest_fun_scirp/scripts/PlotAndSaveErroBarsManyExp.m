%Script to plot only the error bar from exps
...
%             ylabel('Average Accuracy','FontSize',12)
        ...
        if i==1
            saveas(h, [dir2save{1,1},TSname,'AverageAccuracy.fig']);
            clf;
            clear h
        elseif i==2
            saveas(h, [dir2save{1,1},TSname,'AverageNRMS.fig']);
            %saveas(h, [dir2save{1,1},TSname,'AverageNRMS.eps']); %works
            clf;
            clear h
        elseif i==3
            saveas(h, [dir2save{1,1},TSname,'AverageConn.fig']);
            clf;
            clear h
        elseif i==4
            saveas(h, [dir2save{1,1},TSname,'Averageinputs.fig']);
            clf;
            clear h
        elseif i==5
            saveas(h, [dir2save{1,1},TSname,'Averagehidden.fig']);
            clf;
            clear h
        end
    end
