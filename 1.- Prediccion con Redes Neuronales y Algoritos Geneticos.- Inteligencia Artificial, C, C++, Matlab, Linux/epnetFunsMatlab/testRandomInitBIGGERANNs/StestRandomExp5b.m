...
% and the HH section is used the non-normalized exponential decaying
% function including a modified version of it to make different HH
% 
% To run the first part ofthis exp put minOut and maxOut to 1, 
% in the second part put maxOut to n
%
% Plot it with plot1y5Both('resExp5a');
%
% Created:      11 Nov 2010
% Modified at:  12 Nov 2010
...
%             idxOutput = 1:noOut;
            ...
            for i = hiddenN
                ...
                for j = hiddenN
                    if (j > i)
                        probMat(i,j) = localConnSnoNorm(idxConti+1,idxContj,sigmaD);
                    end
                    idxContj = idxContj + 1;
                end
                idxConti = idxConti + 1;
