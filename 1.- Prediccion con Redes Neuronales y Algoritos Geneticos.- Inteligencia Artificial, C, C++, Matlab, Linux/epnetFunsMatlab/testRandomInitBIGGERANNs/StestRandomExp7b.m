...
%             for i = posinputs
%                 probMat = fillColsEnonN(probMat,i,hiddenN,sigmaD);
%             end
%             
            %IH
            probMat = fillMatE(probMat,posinputs,hiddenN, sigmaD,'norm');

            %HH
            % Fill for st all lines
            idxi = 1;
            ...
            % fill first all columns
%             idxj = 1;
%             for i = hiddenN( 1,1:(size(hiddenN,2)-1) )
%                 probMat = fillColsEnonN(probMat,i,hiddenN(1,idxj+1:size(hiddenN,2) ), sigmaD);
%                 idxj = idxj + 1;
%             end
            
            
             %HO
              probMat = fillMatE(probMat,hiddenN,outputN, sigmaD,'norm');
