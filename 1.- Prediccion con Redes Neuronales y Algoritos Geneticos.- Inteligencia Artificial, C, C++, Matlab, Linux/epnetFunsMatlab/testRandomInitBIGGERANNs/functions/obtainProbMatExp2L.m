...
function probM = obtainProbMatExp2L(noInp, noHid, noOut, inputs, hidden, outputs,exp)
...
probM = fillMatDiag(probM,inputs,[hidden outputs],I2HlineI, I2OcolF,exp);

% H2H and H2O at the same time, cols first then lines
probM = fillMatH2HObyCols(probM,hidden,outputs,H2HlineI, H2OcolF,exp);
