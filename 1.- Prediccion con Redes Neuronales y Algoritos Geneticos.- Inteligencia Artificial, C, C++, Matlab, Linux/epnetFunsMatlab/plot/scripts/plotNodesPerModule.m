...
if strcmp(typePlot, 'AV')
    ...
    for alldir = 1:info{1,1}.noModules
        h = plot(info{1,1}.AvNodesPerModule{alldir,1}, lines{1,alldir},'LineWidth',1);    
    end
    
elseif strcmp(typePlot, 'STD')
    
    for alldir = 1:info{1,1}.noModules
        h = errorbar(info{1,1}.AvNodesPerModule{alldir,1}, info{1,1}.stdNodesPerModule{alldir,1}, lines{1,alldir},'LineWidth',1);
    end
    
elseif strcmp(typePlot, 'STE')
    
    for alldir = 1:info{1,1}.noModules
        h = errorbar(info{1,1}.AvNodesPerModule{alldir,1}, info{1,1}.steNodesPerModule{alldir,1}, lines{1,alldir},'LineWidth',1);
    end
end
