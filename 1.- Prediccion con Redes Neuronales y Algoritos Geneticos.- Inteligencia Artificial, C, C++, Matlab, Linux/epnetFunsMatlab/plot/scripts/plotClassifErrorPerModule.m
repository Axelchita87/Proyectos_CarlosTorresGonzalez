...
if strcmp(typePlot, 'AV')
    ...
    for alldir = 1:info{1,1}.noModules
        h = plot(info{1,1}.AvClassifErrPerMod{alldir,1}, lines{1,alldir},'LineWidth',1);    
    end
    
elseif strcmp(typePlot, 'STD')
    
    for alldir = 1:info{1,1}.noModules
        h = errorbar(info{1,1}.AvClassifErrPerMod{alldir,1}, info{1,1}.stdClassifErrPerMod{alldir,1}, lines{1,alldir},'LineWidth',1);
    end
    
elseif strcmp(typePlot, 'STE')
    
    for alldir = 1:info{1,1}.noModules
        h = errorbar(info{1,1}.AvClassifErrPerMod{alldir,1}, info{1,1}.steClassifErrPerMod{alldir,1}, lines{1,alldir},'LineWidth',1);
    end
end
