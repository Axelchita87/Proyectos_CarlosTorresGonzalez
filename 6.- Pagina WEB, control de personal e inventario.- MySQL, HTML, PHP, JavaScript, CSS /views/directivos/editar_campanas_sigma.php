				...
				<form action="" method="POST" enctype="multipart/form-data" role="form" id="form-alta-campana">
					...
					<div class="box box-primary">
						...
						<div class="box-body">
							...
							<div class="">
								<button type="submit" value="Guardar" name="btn_enviar_cambiar_campana" class="btn btn-primary">Guardar</button>
								<button type="submit" value="Cancelar" name="btn_cancelar_alta_campana" class="btn btn-primary">Cancelar</button>
							</div>
