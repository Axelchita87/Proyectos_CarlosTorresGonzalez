    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <!-- Default box -->
          <form action="index.php?command=cuestionario1_promotor" method="POST" enctype="multipart/form-data"  role="form" id="form-alta" >
            <div class="row">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-8 col-sm-6 col-xs-12">
                          <div class="input-group">
                            ...
                            <select name="nombre_cac" id="nombre_cac"  class="form-control">
