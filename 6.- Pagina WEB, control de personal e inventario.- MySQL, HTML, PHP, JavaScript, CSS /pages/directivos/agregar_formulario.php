    ...
    function construir_formulario(){
        ...
        ?>
         ...
         var s= '<div class="row grid pre_campo">'+
                    '<div class="t_d_value col-md-8 col-sm-8 col-xs-8"><input type="text" name="p_label" id="p_label" class="campo col-md-12 col-sm-12 col-xs-12" placeholder="Label"></div>'+
                    '<div class="t_d_value col-md-1 col-sm-1 col-xs-1" style="text-align:center"><div class="btn-xs btn-xs-add-ask">+</div></div>'+
...
<div border="0" class="table-responsive">
	<?php require "views/directivos/menu_vertical.php" ?>
        ...
        <div id="contenedor">
            ...
            <h3> Informacion extra para formularios </h3>
            ...
            <div id="" class="cont-form col-md-10">
                    ...
                    <div class="label-h">Formularios personalizados</div>
                    <div class="caja-campos row">
                    	<div class="row grid controls form_extra">
                            <div class="btn-xs" title="Ver respuesta de formularios" data-toggle="tooltip" data-placement="bottom"  id="btn_form_f_"><a href="index.php?command=respuestas_cuestionarios"><img  src="images/logo_ver.png" style="width:100%" /></a></div>
                    		<div class="btn-xs" title="Agregar un nuevo formulario" data-toggle="tooltip" data-placement="bottom"  id="btn_form_f_add">+</div>
                    	</div>
                    	<div class="row grid">
                            <div class="t_h_label col-md-8 col-sm-8 col-xs-8">Nombre del Formulario</div>
                            <div class="t_h_label col-md-1 col-sm-1 col-xs-1">Añadir<br>Preguntas</div>
