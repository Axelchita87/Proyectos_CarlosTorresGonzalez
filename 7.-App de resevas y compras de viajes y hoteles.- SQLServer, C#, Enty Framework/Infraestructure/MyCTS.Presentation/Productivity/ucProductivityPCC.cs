...
{
    public partial class ucProductivityPCC : CustomUserControl
    {
        /// <summary>
        ...
        private void ucProductivityPCC_Load(object sender, EventArgs e)
        {
            ...
            using (Components.MyCTSExcel MyCTSExcel = new Components.MyCTSExcel())
            {
                ...
                if (MyCTSExcel.IsObjectCreated)
                {
                    ...
                    if (rdoWeek.Checked)
                    {
                        ...
                        cell = new MyCTSExcel.Cell(14, 1, "Records");
                        cell.ShowBorder = false;
                        MyCTSExcel.CreateCell(cell);
