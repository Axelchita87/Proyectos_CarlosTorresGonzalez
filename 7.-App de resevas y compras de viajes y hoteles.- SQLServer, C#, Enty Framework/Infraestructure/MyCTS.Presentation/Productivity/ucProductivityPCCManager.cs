...
{
    public partial class ucProductivityPCCManager : CustomUserControl
    {
        ...
        public ucProductivityPCCManager()
        {
            InitializeComponent();
        ...
        //Carga los datos de meses y semanas en los combos
        private void ucProductivityPCCManager_Load(object sender, EventArgs e)
        {
        ...
        //Llama el metodo de Validación y muestra el ProgressBar y manda a llamar los procesos de forma asincrona
        ...
        //Muestra el porcentaje del progress Bar
        ...
        //Valida los campos obligarorios
        ...
        {
            List<UserProductivityPerPCC> listProductivity = null;
            List<UserProductivityPerPCC> listProductivity2 = null;
            if (rdoWeek.Checked)
            {
                if (rol)
                {
                    listProductivity =
                    UserProductivityPerPCCBL.GetUserProductivityPerPCC(txtAgent.Text, week, 1);
                }
                else
                {
                    listProductivity =
                    UserProductivityPerPCCBL.GetUserProductivityPerPCC(Login.Agent, week, 1);
                }
            ...
            else if (rdoMonth.Checked)
            {
                ...
                {
                    listProductivity2 =
                    UserProductivityPerPCCBL.GetUserProductivityPerPCC(txtAgent.Text, month, 2);
                }
                else
                {
                    listProductivity2 =
                    UserProductivityPerPCCBL.GetUserProductivityPerPCC(Login.Agent, month, 2);
                }
            ...
            List<UserProductivityPerPCC> listProductivity3 = null;
            // UserProductivityPerPCCBL.GetUserProductivityPerPCC("OJ", "26-01-2010", 3);
        ...
        private void CreateExcel(List<UserProductivityPerPCC> listProductivity, List<UserProductivityPerPCC> listProductivity2,
                                 List<UserProductivityPerPCC> listProductivity3)
        {
            ...
            using (Components.MyCTSExcel MyCTSExcel = new Components.MyCTSExcel())
            {
                ...
                {
                    AgentPCC pcc = AgentPCCBL.GetAgentPCC(txtAgent.Text);
                    pcc1 = pcc.PCC;
                    ...
                    if (rdoWeek.Checked)
                    {
                        ...
                        cell = new MyCTSExcel.Cell(2, 12, "PCC:  " + Login.PCC);
                        cell.ShowBorder = false;
                        cell.FontSize = 11;
                        MyCTSExcel.CreateCell(cell);
                    ...
                    //objExcel.CreateCell2(1, 2, 12, "PCC:  "+ Login.PCC,false,1,-1,11);
