...
{
    public partial class ucProductivityReport : CustomUserControl
    {
        ...
        private void ProductivityReport_Load(object sender, EventArgs e)
        {
        ...
        private void DataExtract()
        {
            ...
            {
                listProductivity2 =
                UserProductivityGenericBL.GetUserProductivityPerMonth(Login.Agent, month);//Login.Agent
