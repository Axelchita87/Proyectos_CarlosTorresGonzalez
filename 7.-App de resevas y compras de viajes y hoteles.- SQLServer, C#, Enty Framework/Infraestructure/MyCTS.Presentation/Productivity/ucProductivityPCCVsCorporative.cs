...
{
    public partial class ucProductivityPCCVsCorporative : CustomUserControl
    {
        /// <summary>
        ...
        public ucProductivityPCCVsCorporative()
        {
            InitializeComponent();
        ...
        //Carga los datos de las fechas correspondientes a semanas y meses
        private void ucProductivityPCCVsCorporative_Load(object sender, EventArgs e)
        {
        ...
        /// <summary>
        /// Valida los campos obligatorios y manda a llamar un proceso de forma asincrona
        /// </summary>
        ...
        private void btnAccept_Click(object sender, EventArgs e)
        {
            if (IsValidateBusinessRules)
            {
                ...
                SenderCallBack scb = new SenderCallBack(DataExtract);
        ...
        //Muestra los datos de la lista de PCC
        ...
        //Pone el tab stop en true del radio button
        ...
        //Muestra y oculta los elementos
        ...
        //Valida que los campos obligatorios sean ingresados
        private bool IsValidateBusinessRules
        {
            get
            {
                if (rdoMonth.Checked == false &&
        ...
        //Llena el combo con las semanas 
        ...
        private void DataExtract()
        {
            ...
            pcc = txtPCC.Text;
            List<ProductivityPCCVsCorporative> listProductivity = null;
            List<ProductivityPCCVsCorporative> listProductivity2 = null;
            if (rdoWeek.Checked)
            {
                listProductivity =
                ProductivityPCCVsCorporativeBL.GetProductivityPCCVsCorporative(pcc, week, 1);
            ...
            {
                listProductivity2 =
                ProductivityPCCVsCorporativeBL.GetProductivityPCCVsCorporative(pcc, month, 2);
            ...
            List<ProductivityPCCVsCorporative> listProductivity3 = null;
            // ProductivityPCCVsCorporativeBL.GetUserProductivityPerPCC("OJ", "26-01-2010", 3);
        ...
        //Crea el excel con los datos previamente extraidos
        private void CreateExcel(List<ProductivityPCCVsCorporative> listProductivity, List<ProductivityPCCVsCorporative> listProductivity2,
                                 List<ProductivityPCCVsCorporative> listProductivity3)
        {
            ...
            using (Components.MyCTSExcel MyCTSExcel = new Components.MyCTSExcel())
            {
                ...
                if (MyCTSExcel.IsObjectCreated)
                {
                    ...
                    if (rdoWeek.Checked)
                    {
                        ...
                        cell = new MyCTSExcel.Cell(1, 4, "REPORTE DE PRODUCTIVIDAD PCC Vs CORPORATIVO");
                        ...
                        cell = new MyCTSExcel.Cell(2, 12, "PCC " + txtPCC.Text.Trim());
                        cell.ShowBorder = false;
                        cell.FontSize = 11;
                        MyCTSExcel.CreateCell(cell);
                        ...
                        cell = new MyCTSExcel.Cell(6, 2, "PCC");
                        cell.Bold = true;
                        MyCTSExcel.CreateCell(cell);

                        cell = new MyCTSExcel.Cell(6, 3, "Indice Corporativo");
                        cell.Bold = true;
                        cell.WrapText = false;
                        cell.Alignment = MyCTSExcel.Alignment.MiddleCenter;
                        MyCTSExcel.CreateCell(cell);

                        cell = new MyCTSExcel.Cell(6, 4, "%Productividad PCC Vs \n" + "Indice Corporativo \n");
                        cell.WrapText = true;
                        cell.Bold = true;
                        cell.Wide = 1;
                        cell.Alignment = MyCTSExcel.Alignment.MiddleCenter;
                        ...
                        cell = new MyCTSExcel.Cell(6, 7, "PCC");
                        cell.Bold = true;
                        MyCTSExcel.CreateCell(cell);

                        cell = new MyCTSExcel.Cell(6, 8, "Indice Corporativo");
                        cell.Bold = true;
                        cell.WrapText = true;
                        cell.Alignment = MyCTSExcel.Alignment.MiddleCenter;
                        MyCTSExcel.CreateCell(cell);

                        cell = new MyCTSExcel.Cell(6, 9, "%Productividad PCC Vs \n" + "Indice Corporativo \n");
                        cell.Bold = true;
                        cell.Wide = 1;
                        cell.Alignment = MyCTSExcel.Alignment.MiddleCenter;
                        MyCTSExcel.CreateCell(cell);

                        cell = new MyCTSExcel.Cell(13, 2, "PCC");
                        cell.Bold = true;
                        MyCTSExcel.CreateCell(cell);

                        cell = new MyCTSExcel.Cell(13, 3, "Indice Corporativo");
                        cell.Bold = true;
                        cell.WrapText = true;
                        cell.Alignment = MyCTSExcel.Alignment.MiddleCenter;
                        MyCTSExcel.CreateCell(cell);

                        cell = new MyCTSExcel.Cell(13, 4, "%Productividad PCC Vs \n" + "Indice Corporativo \n");
                        cell.Bold = true;
                        cell.Wide = 1;
                        cell.Alignment = MyCTSExcel.Alignment.MiddleCenter;
                        MyCTSExcel.CreateCell(cell);

                        cell = new MyCTSExcel.Cell(13, 7, "PCC");
                        cell.Bold = true;
                        MyCTSExcel.CreateCell(cell);

                        cell = new MyCTSExcel.Cell(13, 8, "Indice Corporativo");
                        cell.Bold = true;
                        cell.WrapText = true;
                        cell.Alignment = MyCTSExcel.Alignment.MiddleCenter;
                        MyCTSExcel.CreateCell(cell);

                        cell = new MyCTSExcel.Cell(13, 9, "%Productividad PCC Vs \n" + "Indice Corporativo \n");
                        cell.Bold = true;
                        cell.Wide = 1;
                        cell.Alignment = MyCTSExcel.Alignment.MiddleCenter;
                        MyCTSExcel.CreateCell(cell);

                        cell = new MyCTSExcel.Cell(18, 2, "PCC");
                        cell.Bold = true;
                        MyCTSExcel.CreateCell(cell);

                        cell = new MyCTSExcel.Cell(18, 3, "Indice Corporativo");
                        cell.Bold = true;
                        cell.WrapText = true;
                        cell.Alignment = MyCTSExcel.Alignment.MiddleCenter;
                        MyCTSExcel.CreateCell(cell);
                        ...
                        cell = new MyCTSExcel.Cell(18, 4, "%Productividad PCC Vs \n" + "Indice Corporativo \n");
                        cell.Bold = true;
                        cell.Wide = 1;
                        cell.Alignment = MyCTSExcel.Alignment.MiddleCenter;
                        MyCTSExcel.CreateCell(cell);

                        cell = new MyCTSExcel.Cell(18, 7, "PCC");
                        cell.Bold = true;
                        MyCTSExcel.CreateCell(cell);

                        cell = new MyCTSExcel.Cell(18, 8, "Indice Corporativo");
                        cell.Bold = true;
                        cell.WrapText = true;
                        cell.Alignment = MyCTSExcel.Alignment.MiddleCenter;
                        MyCTSExcel.CreateCell(cell);

                        cell = new MyCTSExcel.Cell(18, 9, "%Productividad PCC Vs \n" + "Indice Corporativo \n");
                        cell.Bold = true;
                        cell.Wide = 1;
                        cell.Alignment = MyCTSExcel.Alignment.MiddleCenter;
                        MyCTSExcel.CreateCell(cell);

                        cell = new MyCTSExcel.Cell(6, 12, "%Productividad semana actual" + "\n" + "Vs semana anterior");
                        cell.Bold = true;
                        cell.Wide = 1;
                        cell.Alignment = MyCTSExcel.Alignment.MiddleCenter;
                        MyCTSExcel.CreateCell(cell);

                        cell = new MyCTSExcel.Cell(13, 12, "%Productividad semana actual" + "\n" + "Vs semana anterior");
                        cell.Bold = true;
                        cell.Wide = 1;
                        cell.Alignment = MyCTSExcel.Alignment.MiddleCenter;
                        MyCTSExcel.CreateCell(cell);

                        cell = new MyCTSExcel.Cell(18, 12, "%Productividad semana actual" + "\n" + "Vs semana anterior");
                        cell.Bold = true;
                        cell.Wide = 1;
                        cell.Alignment = MyCTSExcel.Alignment.MiddleCenter;
                        MyCTSExcel.CreateCell(cell);
                    ...
                    else
                    {
                        ...
                        cell = new MyCTSExcel.Cell(6, 12, "%Productividad mes actual" + "\n" + "Vs mes anterior");
                        cell.Bold = true;
                        cell.Wide = 1;
                        cell.Alignment = MyCTSExcel.Alignment.MiddleCenter;
                        MyCTSExcel.CreateCell(cell);

                        cell = new MyCTSExcel.Cell(13, 12, "%Productividad mes actual" + "\n" + "Vs mes anterior");
                        cell.Bold = true;
                        cell.Wide = 1;
                        cell.Alignment = MyCTSExcel.Alignment.MiddleCenter;
                        MyCTSExcel.CreateCell(cell);

                        cell = new MyCTSExcel.Cell(18, 12, "%Productividad mes actual" + "\n" + "Vs mes anterior");
                        cell.Bold = true;
                        cell.Wide = 1;
                        cell.Alignment = MyCTSExcel.Alignment.MiddleCenter;
                        MyCTSExcel.CreateCell(cell);
                    ...
                    //objExcel.CreateCell2(1, 6, 12, "%Productividad semana actual" + "\n" + "Vs semana anterior", true, 1, 10);
                    //objExcel.CreateCell2(1, 13, 12, "%Productividad semana actual" + "\n" + "Vs semana anterior", true, 1, 10);
                    //objExcel.CreateCell2(1, 18, 12, "%Productividad semana actual" + "\n" + "Vs semana anterior", true, 1, 10);
