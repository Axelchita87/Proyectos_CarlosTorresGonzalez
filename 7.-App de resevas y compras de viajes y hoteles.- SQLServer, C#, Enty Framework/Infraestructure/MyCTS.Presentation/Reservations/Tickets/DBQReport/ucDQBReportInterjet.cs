...
{
    public partial class ucDQBReportInterjet : CustomUserControl
    {
 
        public ucDQBReportInterjet()
        {
            InitializeComponent();
        ...
        private void ucDQBReportInterjet_Load(object sender, EventArgs e)
        {
        ...
        private void ucDQBReportInterjet_KeyDown(object sender, KeyEventArgs e)
        {
