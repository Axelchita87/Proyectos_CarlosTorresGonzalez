...
{
    public partial class ucPhase35375 : CustomUserControl
    {
        /// <summary>
        /// Descripción: User Control que permite forzar la tarifa para el record
        ///              presente en MySabre por segmentos o para todo el itinerario.
        ...
        public ucPhase35375()
        {
            ...
            this.InitialControlFocus = rdoQuaAllItinerary;
        ...
        private void QuaAllItineraryCommandsSend()
        {
            ...
            string passType;
            string passPosition;
            quaAllItinerary = Resources.Constants.COMMANDS_WPQ;
            if (this.Parameters != null)
            {
                passType = this.Parameters[0];
            ...
            {
                sabreAnswer = objCommand.SendReceive(sendAllItinerary);
            }
        ...
        private void BusinnesRulesFirstRow()
        {
            ...
            else if ((statusPercentageBySegments) && (!string.IsNullOrEmpty(txtDiscountS1.Text)) && (txtDiscountS1.Text.Length > 2))
            {
        ...
        private void BusinnesRulesSecondRow()
        {
           ...
           (!statusQuantityBySegments))
            ...
            else if ((statusPercentageBySegments) && (!string.IsNullOrEmpty(txtDiscountS2.Text)) && (txtDiscountS2.Text.Length > 2))
            {
        ...
        private void BusinessRulesThirdRow()
        {
           ...
           (!statusQuantityBySegments))
            ...
            else if ((statusPercentageBySegments) && (!string.IsNullOrEmpty(txtDiscountS3.Text)) && (txtDiscountS3.Text.Length > 2))
            {
        ...
        private void BusinessRulesFourthRow()
        {
           ...
           (!statusQuantityBySegments))
            ...
            else if ((statusPercentageBySegments) && (!string.IsNullOrEmpty(txtDiscountS4.Text)) && (txtDiscountS4.Text.Length > 2))
            {
        ...
        private void BusinessRulesFifthRow()
        {
            ...
            else if ((statusPercentageBySegments) && (!string.IsNullOrEmpty(txtDiscountS5.Text)) && (txtDiscountS5.Text.Length > 2))
            {
        ...
        private void BusinessRulesSixthRow()
        {
            ...
            else if ((statusPercentageBySegments) && (!string.IsNullOrEmpty(txtDiscountS6.Text)) && (txtDiscountS6.Text.Length > 2))
            {
        ...
        private void BusinessRulesSeventhRow()
        {
           ...
           (!statusQuantityBySegments))
            ...
            else if ((statusPercentageBySegments) && (!string.IsNullOrEmpty(txtDiscountS7.Text)) && (txtDiscountS7.Text.Length > 2))
            {
        ...
        private void BusinessRulesEighthRow()
        {
           ...
           (!statusQuantityBySegments))
            ...
            else if ((rdoPercentageBySegments.Checked) && (!string.IsNullOrEmpty(txtDiscountS8.Text)) && (txtDiscountS8.Text.Length > 2))
            {
        ...
        /// <summary>
        /// Construcción y envio de comando a MySabre cuando la opción "Por segmentos" 
        /// esta activa
        /// </summary>
        /// <returns></returns>
        private void QuaBySegmentsCommandsSend()
        {
            ...
            using (CommandsAPI objCommand = new CommandsAPI())
            {
                sabreAnswer = objCommand.SendReceive(sendAll);
            }
        }
        ...
        private void CommandsSendFirstRow()
        {
            ...
            if (!string.IsNullOrEmpty(txtBeginS1.Text))
            {
                beginS1 = string.Concat(Resources.Constants.COMMANDS_S,
                    txtBeginS1.Text);
            }
            else
            {
            ...
            {
                sendFirstRow = string.Concat(Resources.Constants.COMMANDS_WP,
                    sendFirstRow);
            }
        ...
        //Evento rdoQuaAllItinerary_CheckedChanged
        ...
        //Evento rdoQuaBySegments_CheckedChanged
