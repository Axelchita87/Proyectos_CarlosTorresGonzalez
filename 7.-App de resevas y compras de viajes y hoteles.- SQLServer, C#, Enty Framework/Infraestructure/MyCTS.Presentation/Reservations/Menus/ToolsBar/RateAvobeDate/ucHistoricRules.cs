...
{
    public partial class ucHistoricRules : CustomUserControl
    {
        /// <summary>
        /// Descripción: Muestra las reglas de tarifas de fechas anteriores de un itinerario
        ...
        private void ucHistoricRules_Load(object sender, EventArgs e)
        {
        ...
        private bool IsValidBussinessRules
        {
            get
            {
                ...
                {
                    MessageBox.Show(Resources.Reservations.REQUIERE_INGRESAR_FARE_BASIS, Resources.Constants.MYCTS, MessageBoxButtons.OK, MessageBoxIcon.Information);
                    txtFareBasis.Focus();
                }
        ...
        private void commandsSend()
        {
            ...
            send = string.Concat(send, txtTicketsDate.Text, txtOriginCity.Text,
                txtDestinationCity.Text, txtDepartureDate.Text,txtFareBasis.Text, Resources.Constants.INDENT,
                txtAirLine.Text);
        ...
        {
            if (txtFareBasis.Text.Length > 15)
                btnAccept.Focus();
        }
