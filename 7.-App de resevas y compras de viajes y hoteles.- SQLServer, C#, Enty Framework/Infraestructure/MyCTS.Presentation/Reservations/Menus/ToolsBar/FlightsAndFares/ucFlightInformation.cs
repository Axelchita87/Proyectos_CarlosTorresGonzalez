...
{
    public partial class ucFlightInformation : CustomUserControl
    {

        /// <summary>
        /// Descripción: User Control que permite desplegar la información del vuelo
        ...
        private void ucFlightInformation_Load(object sender, EventArgs e)
        {
