...
namespace MyCTS.Presentation
{
    ...
    /// 
    /// </summary>
    public partial class ucInterJetContactPassangerCaptureForm : CustomUserControl
    {
        /// <summary>
        /// 
        /// </summary>
        private InterJetContactPassangerFormHandler _contactHandler;

        /// <summary>
        /// Gets the inter jet contact passanger form handler.
        /// </summary>
        private InterJetContactPassangerFormHandler InterJetContactPassangerFormHandler
        {
            get
            {
                ...
                if (this._contactHandler == null)
                {
                    ...
                    this._contactHandler = new InterJetContactPassangerFormHandler
                    {
        ...
        /// </summary>
        public ucInterJetContactPassangerCaptureForm()
        {
            InitializeComponent();
        ...
        public static ListItem[] Countries
        {
            get
            {
                return InterJetContactPassangerFormHandler.Countries;
            }
        }
