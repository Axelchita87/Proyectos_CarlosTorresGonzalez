...
{
    public class InterJetContactPassangerFormHandler : InterJetUserControlHandler
    {
        ...
        public void LoadInterJetPassangerUserControl()
        {
            ...
            Loader.AddToPanelWithParameters(Loader.Zone.Middle, this.CurrentForm, "ucInterJetPassangerCaptureForm", this.CurrentForm.Parameter, null);
        }
        ...
        public void ContinueWithSellProcessOrCaptureInfantInformation()
        {
            ...
            this.Session["CurrentTicket"] = this.GenerateTicket();
            if (this.Session["UserInput"] != null)
            {
                ...
                if (userInput.HasInfantPassanger)
                {
                    ...
                    Loader.AddToPanelWithParameters(Loader.Zone.Middle, this.CurrentForm, "ucInterJetInfantCaptureForm", this.CurrentForm.Parameter, null);
                }
                else
                {
        ...
        private void FillContactEntity()
        {
            ...
            SmartTextBox addres3TextBox = this.GetSmartTextBoxByName("contactAddress2TextBox");
            ...
            theContact.State = stateComboBox.SelectedItem != null ? stateComboBox.SelectedValue.ToString() : "";
            ...
            theContact.Country = countryTextComboBox.SelectedItem != null ? countryTextComboBox.SelectedValue.ToString() : "";
            ...
            theContact.PrimaryTelephone = primaryTelephone.Text.Replace(" ",string.Empty);

            SmartTextBox alternTelephone = this.GetSmartTextBoxByName("contactAlternTelephoneTextbox");
            theContact.AlternTelephone = alternTelephone.Text.Replace(" ", string.Empty);

            SmartTextBox cellPhoneTextBox = this.GetSmartTextBoxByName("contactCellPhoneTextBox");
            theContact.CellPhone = cellPhoneTextBox.Text.Replace(" ", string.Empty);
        ...
        private void ValidateTextBox(TextBox theTextBox, string field)
        {
            ...
            {
                theTextBox.Focus();
                ErrorProvider.SetError(theTextBox, string.Format(InterJetContactPassangerFormHandler.CONTACT_FIELD_FAUL, field));
                throw new Exception(string.Format(InterJetContactPassangerFormHandler.CONTACT_FIELD_FAUL, field));
            }
        }
        ...
        private void SetAgentAsContact(InterJetAgentContact contact)
        {
            ...
            ComboBox stateComboBox = this.GetComboBoxByName("contactStateComboBox");
            stateComboBox.SelectedValue = contact.State;

            SmartTextBox postalCodeTextBox = this.GetSmartTextBoxByName("contactPostalCodeTextBox");
            postalCodeTextBox.Text = contact.PostalCode;
            //TODO : country from catalogo?
            ComboBox countryTextComboBox = this.GetComboBoxByName("contactCountryComboBox");
            countryTextComboBox.SelectedValue = contact.Country;


            SmartTextBox primaryTelephone = this.GetSmartTextBoxByName("contactPrimaryTelephoneTextBox");
            primaryTelephone.Text = contact.PrimaryTelephone.Replace(" ", string.Empty);
        ...
        {
            LogProductivity.LogTransaction(Login.Agent, "4-Desplego Captura de contacto--InterJet");
        ...
        private void SetToolTip()
        {
            ...
            ComboBox stateComboBox = this.GetComboBoxByName("contactStateComboBox");
            this.ToolTiper.SetToolTip(stateComboBox, "Estado del contacto".ToUpper());
        ...
        private void SetContact()
        {
            ...
            if (theContact != null)
            {
                ...
                SmartTextBox primaryTelephone = this.GetSmartTextBoxByName("contactPrimaryTelephoneTextBox");
                primaryTelephone.Text = theContact.PrimaryTelephone.Replace(" ", string.Empty);
