...
{
    public class VolarisControlFactory
    {
        private int segundoInsert = 0;
        ...
        #region SERVICIOS
        private static readonly int X_BASECOORD_PANEL_SERVICIOS = 40;
        private static readonly int Y_BASECOORD_PANEL_SERVICIOS = 110;
        private static readonly int X_HEIGHT_PANEL_SERVICIOS = 0; // size
        private static readonly int Y_WIDHT_PANEL_SERVICIOS = 0;
        #endregion
        ...
        public VolarisPassangerCaptureFormHandler VolarisPassangerCaptureFormHandler
        {
            get;
            set;
        }

        public VolarisServicesExtrasCaptureFormHandler VolarisServicesExtrasCaptureFormHandler
        {
            get;
            set;
        }
        ...
        private Panel CreateDynamicControlsForInfants(int infantNumber, int displacement, Hashtable sessionInProgress)
        {
            ...
            Panel panelForInfants = this.CreatePanel(string.Format("Infant{0}", infantNumber),
                new Point(VolarisControlFactory.X_BASECOORD_PANEL_INFANTS, VolarisControlFactory.Y_BASECOORD_PANEL_INFANTS + displacement),
                new Size(VolarisControlFactory.X_HEIGHT_PANEL_INFANTS, VolarisControlFactory.Y_WIDHT_PANEL_INFANTS)
                );

            GroupBox groupBoxInfant = this.CreateGroupBox(string.Format("InfantGroup{0}", infantNumber),
                new Point(VolarisControlFactory.X_BASECOORD_INFANTS_GROUPBOX, VolarisControlFactory.Y_BASECOORD_INFANTS_GROUPBOX),
                new Size(VolarisControlFactory.X_HEIGHT_INFANTS_GROUPBOX, VolarisControlFactory.Y_WIDHT_INFANTS_GROUPBOX)
                );
            ...
            Label genderLabel = this.CreateLabel(string.Format("genderLabel{0}", infantNumber),
                new Point(VolarisControlFactory.X_BASECOORD_INFANT_GENDER_LABEL, VolarisControlFactory.Y_BASECOORD_INFANT_GENDER_LABEL),
                new Size(VolarisControlFactory.X_HEIGHT_INFANT_GENDER_LABEL, VolarisControlFactory.Y_WIDHT_INFANT_GENDER_LABEL)
                );
            genderLabel.Text = "Sexo:";

            ComboBox genderComboBox = this.CreateComboBox(string.Format("Gender{0}", infantNumber),
                new Point(VolarisControlFactory.X_BASECOORD_INFANT_GENDER_COMBOBOX, VolarisControlFactory.Y_BASECOORD_INFANT_GENDER_COMBOBOX),
                new Size(VolarisControlFactory.X_HEIGHT_INFANT_GENDER_COMBOBOX, VolarisControlFactory.Y_WIDHT_INFANT_GENDER_COMBOBOX)
                );
            ...
            Label dateOfBirthLabel = this.CreateLabel(string.Format("dateofBirthLabel{0}", infantNumber),
                 new Point(VolarisControlFactory.X_BASECOORD_INFANT_DATOFBIRTH_LABEL, VolarisControlFactory.Y_BASECOORD_INFANT_DATOFBIRTH_LABEL),
                 new Size(VolarisControlFactory.X_HEIGHT_INFANT_DATOFBIRTH_LABEL, VolarisControlFactory.Y_WIDHT_INFANT_DATOFBIRTH_LABEL)
                 );
            ...
            ComboBox daysComboBox = this.CreateComboBox(string.Format("dayOfBirth{0}", infantNumber),
                new Point(VolarisControlFactory.X_BASECOORD_INFANT_DAY_COMBOBOX, VolarisControlFactory.Y_BASECOORD_INFANT_DAY_COMBOBOX),
                new Size(VolarisControlFactory.X_HEIGHT_INFANT_DAY_COMBOBOX, VolarisControlFactory.Y_WIDHT_INFANT_DAY_COMBOBOX)
                );
            daysComboBox.DataSource = this.GetDays();
            ComboBox monthComboBox = this.CreateComboBox(string.Format("monthOfBirth{0}", infantNumber),
                new Point(VolarisControlFactory.X_BASECOORD_INFANT_MONTH_COMBOBOX, VolarisControlFactory.Y_BASECOORD_INFANT_MONTH_COMBOBOX),
                new Size(VolarisControlFactory.X_HEIGHT_INFANT_MONTH_COMBOBOX, VolarisControlFactory.Y_WIDHT_INFANT_MONTH_COMBOBOX)
                );
            ...
            ComboBox yearComboBox = this.CreateComboBox(string.Format("yearOfBirth{0}", infantNumber),
                new Point(VolarisControlFactory.X_BASECOORD_INFANT_YEAR_COMBOBOX, VolarisControlFactory.Y_BASECOORD_INFANT_YEAR_COMBOBOX),
                new Size(VolarisControlFactory.X_HEIGHT_INFANT_YEAR_COMBOBOX, VolarisControlFactory.Y_WIDHT_INFANT_YEAR_COMBOBOX)
                );
            ...
            Label countryLabel = this.CreateLabel(string.Format("countryLabel{0}", infantNumber),
                 new Point(VolarisControlFactory.X_BASECOORD_INFANT_COUNTRY_LABEL, VolarisControlFactory.Y_BASECOORD_INFANT_COUNTRY_LABEL),
                 new Size(VolarisControlFactory.X_HEIGHT_INFANT_COUNTRY_LABEL, VolarisControlFactory.Y_WIDHT_INFANT_COUNTRY_LABEL)
                 );

            countryLabel.Text = "País:";
            ComboBox countryComboBox = this.CreateComboBox(string.Format("Country{0}", infantNumber),
                new Point(VolarisControlFactory.X_BASECOORD_INFANT_COUNTRY_COMBOBOX, VolarisControlFactory.Y_BASECOORD_INFANT_COUNTRY_COMBOBOX),
                new Size(VolarisControlFactory.X_HEIGHT_INFANT_COUNTRY_COMBOBOX, VolarisControlFactory.Y_WIDHT_INFANT_COUNTRY_COMBOBOX)
                );
            ...
            Label nacionalityLabel = this.CreateLabel(string.Format("nacionalityLabel{0}", infantNumber),
                 new Point(VolarisControlFactory.X_BASECOORD_INFANT_NACIONALITY_LABEL, VolarisControlFactory.Y_BASECOORD_INFANT_NACIONALITY_LABEL),
                 new Size(VolarisControlFactory.X_HEIGHT_INFANT_NACIONALITY_LABEL, VolarisControlFactory.Y_WIDHT_INFANT_NACIONALITY_LABEL)
                 );
            ...
            ComboBox nacionalityComboBox = this.CreateComboBox(string.Format("Nacionality{0}", infantNumber),
                new Point(VolarisControlFactory.X_BASECOORD_INFANT_NACIONALITY_COMBOBOX, VolarisControlFactory.Y_BASECOORD_INFANT_NACIONALITY_COMBOBOX),
                new Size(VolarisControlFactory.X_HEIGHT_INFANT_NACIONALITY_COMBOBOX, VolarisControlFactory.Y_WIDHT_INFANT_NACIONALITY_COMBOBOX)
                );
            ...
            Label lastNameLabel = this.CreateLabel(string.Format("lastNameLabel{0}", infantNumber),
                 new Point(VolarisControlFactory.X_BASECOORD_INFANT_LASTNAME_LABEL, VolarisControlFactory.Y_BASECOORD_INFANT_LASTNAME_LABEL),
                 new Size(VolarisControlFactory.X_HEIGHT_INFANT_LASTNAME_LABEL, VolarisControlFactory.Y_WIDHT_INFANT_LASTNAME_LABEL)
                 );
            lastNameLabel.Text = "Apellido:";
            TextBox lastNameTextBox = this.CreateTextBox(string.Format("LastName{0}", infantNumber),
                new Point(VolarisControlFactory.X_BASECOORD_INFANT_LASTNAME_TEXTBOX, VolarisControlFactory.Y_BASECOORD_INFANT_LASTNAME_TEXTBOX),
                new Size(VolarisControlFactory.X_HEIGHT_INFANT_LASTNAME_TEXTBOX, VolarisControlFactory.Y_WIDHT_INFANT_LASTNAME_TEXTBOX)
                );
            ...
            Label nameLabel = this.CreateLabel(string.Format("NameLabel{0}", infantNumber),
                 new Point(VolarisControlFactory.X_BASECOORD_INFANT_NAME_LABEL, VolarisControlFactory.Y_BASECOORD_INFANT_NAME_LABEL),
                 new Size(VolarisControlFactory.X_HEIGHT_INFANT_NAME_LABEL, VolarisControlFactory.Y_WIDHT_INFANT_NAME_LABEL)
                 );
            nameLabel.Text = "Nombre:";
            TextBox nameTextBox = this.CreateTextBox(string.Format("Name{0}", infantNumber),
                new Point(VolarisControlFactory.X_BASECOORD_INFANT_NAME_TEXTBOX, VolarisControlFactory.Y_BASECOORD_INFANT_NAME_TEXTBOX),
                new Size(VolarisControlFactory.X_HEIGHT_INFANT_NAME_TEXTBOX, VolarisControlFactory.Y_WIDHT_INFANT_NAME_TEXTBOX)
                );
            ...
            Label titleLabel = this.CreateLabel(string.Format("titleLabel{0}", infantNumber),
             new Point(VolarisControlFactory.X_BASECOORD_INFANT_TITLE_LABEL, VolarisControlFactory.Y_BASECOORD_INFANT_TITLE_LABEL),
             new Size(VolarisControlFactory.X_HEIGHT_INFANT_TITLE_LABEL, VolarisControlFactory.Y_WIDHT_INFANT_TITLE_LABEL)
             );
            titleLabel.Text = "Titulo:";
            ComboBox titleComboBox = this.CreateComboBox(string.Format("Title{0}", infantNumber),
                new Point(VolarisControlFactory.X_BASECOORD_INFANT_TITLE_COMBOBOX, VolarisControlFactory.Y_BASECOORD_INFANT_TITLE_COMBOBOX),
                new Size(VolarisControlFactory.X_HEIGHT_INFANT_TITLE_COMBOBOX, VolarisControlFactory.Y_WIDHT_INFANT_TITLE_COMBOBOX)
                );
            ...
            Label travelWithLabel = this.CreateLabel(string.Format("travelWithLabel{0}", infantNumber),
                 new Point(VolarisControlFactory.X_BASECOORD_INFANT_TRAVELWITH_LABEL, VolarisControlFactory.Y_BASECOORD_INFANT_TRAVELWITH_LABEL),
                 new Size(VolarisControlFactory.X_HEIGHT_INFANT_TRAVELWITH_LABEL, VolarisControlFactory.Y_WIDHT_INFANT_TRAVELWITH_LABEL)
                 );

            travelWithLabel.Text = "Viaja Con:";
            ComboBox travelWithComboBox = this.CreateComboBox(string.Format("PassangerID{0}", infantNumber),
                new Point(VolarisControlFactory.X_BASECOORD_INFANT_TRAVELWITH_COMBOBOX, VolarisControlFactory.Y_BASECOORD_INFANT_TRAVELWITH_COMBOBOX),
                new Size(VolarisControlFactory.X_HEIGHT_INFANT_TRAVELWITH_COMBOBOX, VolarisControlFactory.Y_WIDHT_INFANT_TRAVELWITH_COMBOBOX)
                );
        ...
        private Control GetFareGroupForSegments(InterJetTicket ticket)
        {
            ...
            new Point(VolarisControlFactory.X_BASECOORD_FARES_RESERVATIONRESUME_GROUP, VolarisControlFactory.Y_BASECOORD_FARES_RESERVATIONRESUME_GROUP),
            new Size(VolarisControlFactory.X_HEIGHT_FARES_RESERVATIONRESUME_GROUP, VolarisControlFactory.Y_WIDHT_FARES_RESERVATIONRESUME_GROUP)
            );
            ...
            foreach (InterJetFlight flight in ticket.Flights.GetFlights())
            {
                fareLabelText = string.Concat(fareLabelText,
                                                string.Format(VolarisControlFactory.FARE_CONFIRMATIONLABEL,
            ...
            new Point(VolarisControlFactory.X_BASECOORD_FARES_RESERVATIONRESUME_LABEL, VolarisControlFactory.Y_BASECOORD_FARES_RESERVATIONRESUME_LABEL),
            new Size(VolarisControlFactory.X_HEIGHT_FARES_RESERVATIONRESUME_LABEL, VolarisControlFactory.Y_WIDHT_FARES_RESERVATIONRESUME_LABEL)
            );
        ...
        private Control GetSegmentsGroupForSegments(InterJetTicket ticket)
        {
            ...
            GroupBox segmentsGroupBox = this.CreateGroupBox("segmentsGroupBox",
                new Point(VolarisControlFactory.X_BASECOORD_SEGMENTS_RESERVATIONRESUME_GROUP, VolarisControlFactory.Y_BASECOORD_SEGMENTS_RESERVATIONRESUME_GROUP),
                new Size(VolarisControlFactory.X_HEIGHT_SEGMENTS_RESERVATIONRESUME_GROUP, VolarisControlFactory.Y_WIDHT_SEGMENTS_RESERVATIONRESUME_GROUP)
                );
            ...
            foreach (InterJetFlight flight in ticket.Flights.GetFlights())
            {
                segmentsLabelText = string.Concat(segmentsLabelText, string.Format(VolarisControlFactory.SEGMENTS_CONFIRMATIONLABEL,
                                                                                   flight.DepartureStation,
                                                                                   flight.ArrivalStation,
                                                                                   flight.DepartureStation,
                                                                                   flight.ArrivalStation,
            ...
            Label segmentsLabel = this.CreateLabel("segmentLabel",
                new Point(VolarisControlFactory.X_BASECOORD_SEGMENTS_RESERVATIONRESUME_LABEL, VolarisControlFactory.Y_BASECOORD_SEGMENTS_RESERVATIONRESUME_LABEL),
                new Size(VolarisControlFactory.X_HEIGHT_SEGMENTS_RESERVATIONRESUME_LABEL, VolarisControlFactory.Y_WIDHT_SEGMENTS_RESERVATIONRESUME_LABEL)
                );
        ...
        private Control GetPassangerGroupForReservationResume(InterJetTicket ticket)
        {
            ...
            GroupBox passangerGroupBox = this.CreateGroupBox("PassangerGroupBox",
                new Point(VolarisControlFactory.X_BASECOORD_PAX_RESERVATIONRESUME_GROUP, VolarisControlFactory.Y_BASECOORD_PAX_RESERVATIONRESUME_GROUP),
                new Size(VolarisControlFactory.X_HEIGHT_PAX_RESERVATIONRESUME_GROUP, VolarisControlFactory.Y_WIDHT_PAX_RESERVATIONRESUME_GROUP)
                );
            ...
            {
                passangerLabelInfo = string.Concat(passangerLabelInfo, string.Format(VolarisControlFactory.PASSANGER_CONFIRMATIONLABEL, pax.FullName, ticket.RecordLocator));
            }

            Label passangersLabel = this.CreateLabel("paxLabel",
                new Point(VolarisControlFactory.X_BASECOORD_PAX_RESERVATIONRESUME_LABEL, VolarisControlFactory.Y_BASECOORD_PAX_RESERVATIONRESUME_LABEL),
                new Size(VolarisControlFactory.X_HEIGHT_PAX_RESERVATIONRESUME_LABEL, VolarisControlFactory.Y_WIDHT_PAX_RESERVATIONRESUME_LABEL)
                );
        ...
        public Control[] GetDynamicFlightResumeControls(InterJetTicket ticket, int displacement)
        {
            ...
            foreach (InterJetDetailPriceMessage detail in ticket.DetailsMessages)
            {
                GroupBox group = this.CreateGroupBox("group",
                    new Point(VolarisControlFactory.X_BASECOORD_GROUPBOX_FLIGHTRESUME, VolarisControlFactory.Y_BASECOORD_GROUPBOX_FLIGHTRESUME + newDisplacement),
                    new Size(VolarisControlFactory.X_HEIGHT_GROUPBOX_FLIGHTRESUME, VolarisControlFactory.Y_WIDHT_GROUPBOX_FLIGHTRESUME));
                group.Text = string.Format("Vuelo {0}: {1}", flightCounter, detail.DateTimeFlightString);
                Panel panel = this.CreatePanel("panel",
                   new Point(VolarisControlFactory.X_BASECOORD_CONTAINER_FLIGHTRESUME, VolarisControlFactory.Y_BASECOORD_CONTAINER_FLIGHTRESUME),
                   new Size(VolarisControlFactory.X_HEIGHT_CONTAINER_FLIGHTRESUME, VolarisControlFactory.Y_WIDHT_CONTAINER_FLIGHTRESUME));

                Label header = this.CreateLabel("label",
                  new Point(VolarisControlFactory.X_BASECOORD_HEADER_FLIGHTRESUME, VolarisControlFactory.Y_BASECOORD_HEADER_FLIGHTRESUME),
                  new Size(VolarisControlFactory.X_HEIGHT_HEADER_FLIGHTRESUME, VolarisControlFactory.Y_WIDHT_HEADER_FLIGHTRESUME));
                ...
                if (!string.IsNullOrEmpty(detail.AdultBodyMessage))
                {
                   ...
                   new Point(VolarisControlFactory.X_BASECOORD_ADULT_FLIGHTRESUME, VolarisControlFactory.Y_BASECOORD_ADULT_FLIGHTRESUME),
                   new Size(VolarisControlFactory.X_HEIGHT_ADULT_FLIGHTRESUME, VolarisControlFactory.Y_WIDHT_ADULT_FLIGHTRESUME));
                ...
                if (!string.IsNullOrEmpty(detail.SeniorBodyMessage))
                {
                    ...
                    new Point(VolarisControlFactory.X_BASECOORD_SENIOR_FLIGHTRESUME, VolarisControlFactory.Y_BASECOORD_SENIOR_FLIGHTRESUME),
                    new Size(VolarisControlFactory.X_HEIGHT_SENIOR_FLIGHTRESUME, VolarisControlFactory.Y_WIDHT_SENIOR_FLIGHTRESUME));
                ...
                if (!string.IsNullOrEmpty(detail.ChildBodyMessage))
                {
                    ...
                    new Point(VolarisControlFactory.X_BASECOORD_CHILD_FLIGHTRESUME, VolarisControlFactory.Y_BASECOORD_CHILD_FLIGHTRESUME),
                    new Size(VolarisControlFactory.X_HEIGHT_CHILD_FLIGHTRESUME, VolarisControlFactory.Y_WIDHT_CHILD_FLIGHTRESUME));
                ...
                new Point(VolarisControlFactory.X_BASECOORD_PRICE_FLIGHTRESUME, VolarisControlFactory.Y_BASECOORD_PRICE_FLIGHTRESUME),
                new Size(VolarisControlFactory.X_HEIGHT_PRICE_FLIGHTRESUME, VolarisControlFactory.Y_WIDHT_PRICE_FLIGHTRESUME));
        ...
        private Panel CreateDynamicRowForSpecialService(int passangerNumber, int displacement)
        {
            ...
            Panel panel = this.CreatePanel(string.Format("Pax{0}", passangerNumber),
                new Point(VolarisControlFactory.X_BASECOORD_PANEL_SPECIAL_SERVICE, VolarisControlFactory.Y_BASECOORD_PANEL_SPECIAL_SERVICE + displacement),
                new Size(VolarisControlFactory.X_HEIGHT_PANEL_SPECIAL_SERVICE, VolarisControlFactory.Y_WIDHT_PANEL_SPECIAL_SERVICE + displacement)
                );

            CheckBox selectedServiceCheckBox = this.CreateCheckBox(string.Format("serviceIsNecesary{0}", passangerNumber),
               new Point(VolarisControlFactory.X_BASECOORD_CHECKBOXSPECIALSERVICE, VolarisControlFactory.Y_BASECOORD_CHECKBOXSPECIALSERVICE + displacement),
               new Size(VolarisControlFactory.X_HEIGHT_CHECKBOXSPECIALSERVICE, VolarisControlFactory.Y_WIDHT_CHECKBOXSPECIALSERVICE)
               );
            ...
            ComboBox comboBoxTypeOfService = this.CreateComboBox(string.Format("interjetTitleo{0}", passangerNumber),
                new Point(VolarisControlFactory.X_BASECOORD_COMBOBOX_TYPEOFSERVICE, VolarisControlFactory.Y_BASECOORD_COMBOBOX_TYPEOFSERVICE + displacement),
                new Size(VolarisControlFactory.X_HEIGHT_COMBOBOX_TYPEOFSERVICE, VolarisControlFactory.Y_WIDHT_COMBOBOX_TYPEOFSERVICE + displacement)
              );
            ...
            ComboBox comboBoxNumberOfService = this.CreateComboBox(string.Format("interjetTitle1{0}", passangerNumber),
                  new Point(VolarisControlFactory.X_BASECOORD_COMBOBOX_NUMBEROFSERVICES, VolarisControlFactory.Y_BASECOORD_COMBOBOX_NUMBEROFSERVICES + displacement),
                  new Size(VolarisControlFactory.X_HEIGHT_COMBOBOX_NUMBEROFSERVICES, VolarisControlFactory.Y_WIDHT_COMBOBOX_NUMBEROFSERVICES + displacement)
                );
            ...
            ComboBox selectedFlightsComboBox = this.CreateComboBox(string.Format("interjetTitle11{0}", passangerNumber),
                  new Point(VolarisControlFactory.X_BASECOORD_COMBOBOX_FLIGTH, VolarisControlFactory.Y_BASECOORD_COMBOBOX_FLIGTH + displacement),
                  new Size(VolarisControlFactory.X_HEIGHT_COMBOBOX_FLIGTH, VolarisControlFactory.Y_WIDHT_COMBOBOX_FLIGTH + displacement)
                );
            ...
            Label NoteLabel = this.CreateLabel(string.Format("interjetTitle3{0}", passangerNumber),
              new Point(VolarisControlFactory.X_BASECOORD_NOTELABEL, VolarisControlFactory.Y_BASECOORD_NOTELABEL + displacement),
              new Size(VolarisControlFactory.X_HEIGHT_NOTELABEL, VolarisControlFactory.Y_WIDHT_NOTELABEL + displacement)
            );
            NoteLabel.Text = "Nota:";
            panel.Controls.Add(NoteLabel);

            TextBox noteTextBox = this.CreateTextBox(string.Format("interjetClub2{0}", passangerNumber),
             new Point(VolarisControlFactory.X_BASECOORD_NOTETEXTBOX, VolarisControlFactory.Y_BASECOORD_NOTETEXTBOX + displacement),
             new Size(VolarisControlFactory.X_HEIGHT_NOTETEXTBOX, VolarisControlFactory.Y_WIDHT_NOTETEXTBOX + displacement)
             );
        ...
        {
            Panel panel = this.CreatePanel(string.Format("Pax{0}", passangerNumber),
                new Point(VolarisControlFactory.X_BASECOORD_PANEL_ADULT, VolarisControlFactory.Y_BASECOORD_PANEL_ADULT + displacement),
                new Size(VolarisControlFactory.X_HEIGHT_PANEL_ADULT, VolarisControlFactory.Y_WIDHT_PANEL_ADULT)
                );

            TextBox textBoxInterJetClub = this.CreateTextBox(string.Format("interjetClub{0}", passangerNumber),
                new Point(VolarisControlFactory.X_BASECOORD_CLUBINTERJET_ADULT, VolarisControlFactory.Y_BASECOORD_CLUBINTERJET_ADULT),
                new Size(VolarisControlFactory.X_WIDHT_CLUBINTERJET_ADULT, VolarisControlFactory.Y_HEIGHT_CLUBINTERJET_ADULT)
                );
            ...
            ComboBox comboBoxTitle = this.CreateComboBox(string.Format("interjetTitle{0}", passangerNumber),
                new Point(VolarisControlFactory.X_BASECOORD_TITLE_ADULT, VolarisControlFactory.Y_BASECOORD_TITLE_ADULT),
                new Size(VolarisControlFactory.X_WIDHT_TITLE_ADULT, VolarisControlFactory.Y_BASECOORD_TITLE_ADULT)
                );
            ...
            TextBox textBoxPaxName = this.CreateTextBox(string.Format("interjetName{0}", passangerNumber),
               new Point(VolarisControlFactory.X_BASECOORD_NAME_ADULT, VolarisControlFactory.Y_BASECOORD_NAME_ADULT),
               new Size(VolarisControlFactory.X_WIDHT_NAME_ADULT, VolarisControlFactory.Y_HEIGHT_NAME_ADULT)
               );
            ...
            TextBox textBoxPaxLastName = this.CreateTextBox(string.Format("interjetLastName{0}", passangerNumber),
               new Point(VolarisControlFactory.X_BASECOORD_LASTNAME_ADULT, VolarisControlFactory.Y_BASECOORD_LASTNAME_ADULT),
               new Size(VolarisControlFactory.X_WIDHT_LASTNAME_ADULT, VolarisControlFactory.Y_HEIGHT_LASTNAME_ADULT)
              );
           ...
           new Point(VolarisControlFactory.X_BASECOORD_SUFFIX_ADULT, VolarisControlFactory.Y_BASECOORD_SUFFIX_ADULT),
           new Size(VolarisControlFactory.X_WIDHT_SUFFIX_ADULT, VolarisControlFactory.Y_HEIGHT_SUFFIX_ADULT)
           );
           ...
           new Point(VolarisControlFactory.X_BASECOORD_ADULT_ISCONTACT, VolarisControlFactory.Y_BASECOORD_ADULT_ISCONTACT),
           new Size(VolarisControlFactory.X_WIDHT_ADULT_ISCONTACT, VolarisControlFactory.Y_HEIGHT_ADULT_ISCONTACT)
           );

            checkBox.CheckedChanged += new EventHandler(VolarisPassangerCaptureFormHandler.OnContactChecked);
        ...
        {
            Panel panel = this.CreatePanel(string.Format("Pax{0}", passangerNumber),
                new Point(VolarisControlFactory.X_BASECOORD_PANEL_CHILD, VolarisControlFactory.Y_BASECOORD_PANEL_CHILD + displacement),
                new Size(VolarisControlFactory.X_HEIGHT_PANEL_CHILD, VolarisControlFactory.Y_WIDHT_PANEL_CHILD)
                );

            TextBox textBoxInterJetClub = this.CreateTextBox(string.Format("interjetClub{0}", passangerNumber),
                new Point(VolarisControlFactory.X_BASECOORD_CLUBINTERJET_CHILD, VolarisControlFactory.Y_BASECOORD_CLUBINTERJET_CHILD),
                new Size(VolarisControlFactory.X_WIDHT_CLUBINTERJET_CHILD, VolarisControlFactory.Y_HEIGHT_CLUBINTERJET_CHILD)
                );

            panel.Controls.Add(textBoxInterJetClub);

            ComboBox comboBoxTitle = this.CreateComboBox(string.Format("interjetTitle{0}", passangerNumber),
                new Point(VolarisControlFactory.X_BASECOORD_TITLE_CHILD, VolarisControlFactory.Y_BASECOORD_TITLE_CHILD),
                new Size(VolarisControlFactory.X_WIDHT_TITLE_CHILD, VolarisControlFactory.Y_BASECOORD_TITLE_CHILD)
                );
            ...
            TextBox textBoxPaxName = this.CreateTextBox(string.Format("interjetName{0}", passangerNumber),
               new Point(VolarisControlFactory.X_BASECOORD_NAME_CHILD, VolarisControlFactory.Y_BASECOORD_NAME_CHILD),
               new Size(VolarisControlFactory.X_WIDHT_NAME_CHILD, VolarisControlFactory.Y_HEIGHT_NAME_CHILD)
               );

            panel.Controls.Add(textBoxPaxName);

            TextBox textBoxPaxLastName = this.CreateTextBox(string.Format("interjetLastName{0}", passangerNumber),
               new Point(VolarisControlFactory.X_BASECOORD_LASTNAME_CHILD, VolarisControlFactory.Y_BASECOORD_LASTNAME_CHILD),
               new Size(VolarisControlFactory.X_WIDHT_LASTNAME_CHILD, VolarisControlFactory.Y_HEIGHT_LASTNAME_CHILD)
              );

            panel.Controls.Add(textBoxPaxLastName);

            ComboBox comboBoxSuffix = this.CreateComboBox(string.Format("interjetPaxSuffix{0}", passangerNumber),
           new Point(VolarisControlFactory.X_BASECOORD_SUFFIX_CHILD, VolarisControlFactory.Y_BASECOORD_SUFFIX_CHILD),
           new Size(VolarisControlFactory.X_WIDHT_SUFFIX_CHILD, VolarisControlFactory.Y_HEIGHT_SUFFIX_CHILD)
           );
            comboBoxSuffix.DataSource = this.GetSuffix();
            panel.Controls.Add(comboBoxSuffix);

            CheckBox checkBox = this.CreateCheckBox(string.Format("interjetIsContact{0}", passangerNumber),
           new Point(VolarisControlFactory.X_BASECOORD_CHILD_ISCONTACT, VolarisControlFactory.Y_BASECOORD_CHILD_ISCONTACT),
           new Size(VolarisControlFactory.X_WIDHT_CHILD_ISCONTACT, VolarisControlFactory.Y_HEIGHT_CHILD_ISCONTACT)
           );
            panel.Controls.Add(checkBox);
        ...
        private Panel CreateDynamicRowControlsForSeniorsPax(int passangerNumber, int displacement)
        {
            ...
            Panel panel = this.CreatePanel(string.Format("Pax{0}", passangerNumber),
                new Point(VolarisControlFactory.X_BASECOORD_PANEL_SENIOR, VolarisControlFactory.Y_BASECOORD_PANEL_SENIOR + displacement),
                new Size(VolarisControlFactory.X_HEIGHT_PANEL_SENIOR, VolarisControlFactory.Y_WIDHT_PANEL_SENIOR)
                );

            TextBox textBoxInterJetClub = this.CreateTextBox(string.Format("interjetClub{0}", passangerNumber),
                new Point(VolarisControlFactory.X_BASECOORD_CLUBINTERJET_SENIOR, VolarisControlFactory.Y_BASECOORD_CLUBINTERJET_SENIOR),
                new Size(VolarisControlFactory.X_WIDHT_CLUBINTERJET_SENIOR, VolarisControlFactory.Y_HEIGHT_CLUBINTERJET_SENIOR)
                );

            panel.Controls.Add(textBoxInterJetClub);

            ComboBox comboBoxTitle = this.CreateComboBox(string.Format("interjetTitle{0}", passangerNumber),
                new Point(VolarisControlFactory.X_BASECOORD_TITLE_SENIOR, VolarisControlFactory.Y_BASECOORD_TITLE_SENIOR),
                new Size(VolarisControlFactory.X_WIDHT_TITLE_SENIOR, VolarisControlFactory.Y_BASECOORD_TITLE_SENIOR)
                );
            comboBoxTitle.DataSource = this.GetTitles();
            ...
            TextBox textBoxPaxName = this.CreateTextBox(string.Format("interjetName{0}", passangerNumber),
               new Point(VolarisControlFactory.X_BASECOORD_NAME_SENIOR, VolarisControlFactory.Y_BASECOORD_NAME_SENIOR),
               new Size(VolarisControlFactory.X_WIDHT_NAME_SENIOR, VolarisControlFactory.Y_HEIGHT_NAME_SENIOR)
               );

            panel.Controls.Add(textBoxPaxName);

            TextBox textBoxPaxLastName = this.CreateTextBox(string.Format("interjetLastName{0}", passangerNumber),
               new Point(VolarisControlFactory.X_BASECOORD_LASTNAME_SENIOR, VolarisControlFactory.Y_BASECOORD_LASTNAME_SENIOR),
               new Size(VolarisControlFactory.X_WIDHT_LASTNAME_SENIOR, VolarisControlFactory.Y_HEIGHT_LASTNAME_SENIOR)
              );

            panel.Controls.Add(textBoxPaxLastName);

            ComboBox comboBoxSuffix = this.CreateComboBox(string.Format("interjetPaxSuffix{0}", passangerNumber),
           new Point(VolarisControlFactory.X_BASECOORD_SUFFIX_SENIOR, VolarisControlFactory.Y_BASECOORD_SUFFIX_SENIOR),
           new Size(VolarisControlFactory.X_WIDHT_SUFFIX_SENIOR, VolarisControlFactory.Y_HEIGHT_SUFFIX_CHILD)
           );
            comboBoxSuffix.DataSource = this.GetSuffix();
            ...
            CheckBox checkBox = this.CreateCheckBox(string.Format("interjetIsContact{0}", passangerNumber),
           new Point(VolarisControlFactory.X_BASECOORD_SENIOR_ISCONTACT, VolarisControlFactory.Y_BASECOORD_SENIOR_ISCONTACT),
           new Size(VolarisControlFactory.X_WIDHT_SENIOR_ISCONTACT, VolarisControlFactory.Y_HEIGHT_SENIOR_ISCONTACT)
           );
        ...
        public void LoadInfantUserControl(Control mainContainer, int numberOfInfants, object parameter, KeyEventHandler handler)
        {
            ...
            for (int infantIndex = 1; infantIndex <= numberOfInfants; infantIndex++)
            {
                Panel panelToAdd = this.CreatePanel(string.Format("Infant{0}", infantIndex),
                    new Point(VolarisControlFactory.X_BASECOORD_PANEL_INFANT, VolarisControlFactory.Y_BASECOORD_PANEL_INFANT),
                    new Size(VolarisControlFactory.X_HEIGHT_PANEL_INFANT, VolarisControlFactory.Y_WIDHT_PANEL_INFANT)
                    );
                panelToAdd.AutoSize = true;

                var newInfantUserControl = new ucVolarisPassengerOnly();
        ...
        public void LoadPassangerUserControl(Control mainContainer, int numberOfPax, InterJetPassangerType type, KeyEventHandler eventHandler)
        {
            ...
            for (int paxIndex = 1; paxIndex <= numberOfPax; paxIndex++)
            {
                ...
                Panel panelToAdd = this.CreatePanel(string.Format("Pax{0}", paxIndex),
                    new Point(VolarisControlFactory.X_BASECOORD_PANEL_PASSANGER, VolarisControlFactory.Y_BASECOORD_PANEL_PASSANGER),
                    new Size(VolarisControlFactory.X_HEIGHT_PANEL_PASSANGER, VolarisControlFactory.Y_WIDHT_PANEL_PASSANGER)
                    );
                panelToAdd.AutoSize = true;
                var passangerUserControl = new ucVolarisPassengerOnly();
        ...
        private string GetPassangerType(InterJetPassangerType type)
        {
            switch (type)
            {
                ...
                case InterJetPassangerType.Child:
                    return "Menor";
                case InterJetPassangerType.Infant:
                    return "Infante";
            }
            return "";
        }

        public void LoadServicesExtrasUserControl(Control mainContainer, int numberOfPax, KeyEventHandler eventHandler)
        {
            var controlsToAdd = new List<Control>();
            if (segundoInsert > 0)
            {
                Panel panelToAdd = this.CreatePanel(string.Format("Pax{0}", mainContainer.Controls.Count + 1),
                   new Point(VolarisControlFactory.X_BASECOORD_PANEL_SERVICIOS, VolarisControlFactory.Y_BASECOORD_PANEL_SERVICIOS),
                   new Size(VolarisControlFactory.X_HEIGHT_PANEL_SERVICIOS, VolarisControlFactory.Y_WIDHT_PANEL_SERVICIOS)
                   );
                panelToAdd.AutoSize = true;
                var extrasUserControl = new ucServicesExtrasPassenger();

                extrasUserControl.KeyEventHandler = eventHandler;
                panelToAdd.Controls.Add(extrasUserControl);
                controlsToAdd.Add(panelToAdd);
            }
            ...
            for (int paxIndex = 1; paxIndex <= numberOfPax; paxIndex++)
            {
                ...
                if (paxIndex == 1)
                {
                    extrasUserControl.Focus();
                    segundoInsert++;
                }
                extrasUserControl.KeyEventHandler = eventHandler;
                extrasUserControl.PassangerID = paxIndex.ToString();
                extrasUserControl.GroupBoxTitle = VolarisSession.ExtrasServices[VolarisSession.ExtrasServices.Count -1].TipoServicio;
                extrasUserControl.LabelDeparture = VolarisSession.ItinerarioVolaris[0].Itinerary;
                extrasUserControl.LabelArrival = VolarisSession.ItinerarioVolaris[VolarisSession.ItinerarioVolaris.Count - 1].Itinerary;
                extrasUserControl.TextPax = VolarisSession.AddPassengerComplete[paxIndex - 1].AddPassenger.Nombres + VolarisSession.AddPassengerComplete[paxIndex - 1].AddPassenger.Apellidos;
                panelToAdd.Controls.Add(extrasUserControl);
                controlsToAdd.Add(panelToAdd);
            }
            ...
            for (int i = 0; i < mainContainer.Controls.Count; i++)
            {
                if (mainContainer.Controls[i].Name.StartsWith("Pax"))
                {
                    if (lastControl.Location.IsEmpty)
                    {
                       lastControl.Location = mainContainer.Controls[i].Location;
                    }
                    else
                    {
                        if ( mainContainer.Controls[i].Location.Y > lastControl.Location.Y )
                        {
                            lastControl.Location = mainContainer.Controls[i].Location;
                        }
                    }
            ...
            foreach (Control controlToResize in controlsToAdd)
            {
                ...
                if (counter != 0 || CurrentStack.Count > 0)
                {
                    Control positionControl = CurrentStack.Pop();
                    if (positionControl.Location.Y > lastControl.Location.Y)
                    {
                        lastControl = positionControl;
                    }
                    Point newLocation = lastControl.Location;
                    int y_Displacement = 42;
                    controlToResize.Location = new Point(newLocation.X, newLocation.Y + y_Displacement);
                }
                CurrentStack.Push(controlToResize);
                counter += 1;
