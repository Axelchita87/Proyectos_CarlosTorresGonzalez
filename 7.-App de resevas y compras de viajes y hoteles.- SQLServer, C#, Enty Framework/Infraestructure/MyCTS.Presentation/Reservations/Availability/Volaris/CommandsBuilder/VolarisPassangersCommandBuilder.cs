...
{
    public class VolarisPassangersCommandBuilder : IVolarisCommandBuilder
    {

        public VolarisPassangersCommandBuilder()
        {
        ...
        public void Build()
        {
            ...
            if (Reservation != null)
            {
                ...
                var commands = Reservation.HostCommands.GetPassangersNames();
