...
{
    public class QCControlsClients
    {
        private string qcid;
        public string QCId
        {
        ...
        private string reservationctrltype;
        public string ReservationCtrlType
        {
            get { return reservationctrltype; }
            set { reservationctrltype = value; }
        }
        ...
        private string activeqcclient;
        public string ActiveQCClient
        {
            get { return activeqcclient; }
            set { activeqcclient = value; }
        }
