...
{
    public class GetClientCreditCardNumberDAL
    {
        ...
        public string GetClientCreditCardNumber(string creditCardNumber, string connectionName)
        {
            Database db = DatabaseFactory.CreateDatabase(connectionName);
            DbCommand dbCommand = db.GetStoredProcCommand(Resources.GetClientCreditCardNumberResources.SP_GetClientCreditCardByNumber);
            db.AddInParameter(dbCommand, Resources.GetClientCreditCardNumberResources.PARAM_QUERY1, DbType.String, creditCardNumber);
        ...
        public ClientCreditCard GetClientCreditCardNumberByClient(string Attribute1, string connectionName)
        {
            Database db = DatabaseFactory.CreateDatabase(connectionName);
            DbCommand dbCommand = db.GetStoredProcCommand(Resources.GetClientCreditCardNumberResources.SP_GetClientCreditCardByClient);
            db.AddInParameter(dbCommand, Resources.GetClientCreditCardNumberResources.PARAM_QUERY2, DbType.String, Attribute1);
            ClientCreditCard creditCard = new ClientCreditCard();
            try
            {
