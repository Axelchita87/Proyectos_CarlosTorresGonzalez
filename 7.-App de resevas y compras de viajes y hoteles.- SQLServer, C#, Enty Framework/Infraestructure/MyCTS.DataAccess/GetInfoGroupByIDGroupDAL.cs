...
{
    public class GetInfoGroupByIDGroupDAL
    {
        public List<GetInfoGroup> GetInfoGroupIndex(string idGroup, int OrgId, string connectionName)
        {
            Database db = DatabaseFactory.CreateDatabase(connectionName);
            DbCommand dbCommand = db.GetStoredProcCommand(Resources.GetInfoGroupResources.SP_GETINFOGROUPBYIDGROUP);
            db.AddInParameter(dbCommand, Resources.GetInfoGroupResources.PARAM_QUERY2, DbType.String, idGroup);
