...
{
    public class SetStar2DetailsDAL
    {
        public void SetStar2Details(Star2Details objS2Details, string connectionName)
        {
            Database db = DatabaseFactory.CreateDatabase(connectionName);
            DbCommand dbcomand = db.GetStoredProcCommand(SetStar2DetailsResources.SP_SetStar2Details);
            ...
            db.AddInParameter(dbcomand, UpdateStar2DetailsResources.PARAM_Leasing1, DbType.String, objS2Details.Leasing1);
            db.AddInParameter(dbcomand, UpdateStar2DetailsResources.PARAM_Leasing2, DbType.String, objS2Details.Leasing2);
