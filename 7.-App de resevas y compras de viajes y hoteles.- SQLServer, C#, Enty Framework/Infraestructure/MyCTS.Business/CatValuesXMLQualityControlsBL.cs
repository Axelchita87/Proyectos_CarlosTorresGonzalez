...
{
    public class CatValuesXMLQualityControlsBL
    {
        public static List<CatValuesXMLQualityControls> GetValuesXMLQualityControls(string DKToSearch, string PaxNumber, string C1s, string C2s, string C3s,
        ...
        {
            List<CatValuesXMLQualityControls> GetValuesXMLQualityControlsList = new List<CatValuesXMLQualityControls>();
            CatValuesXMLQualityControlsDAL objGetValuesXMLQualityControls = new CatValuesXMLQualityControlsDAL();
            try
            {
                try
                {
                    GetValuesXMLQualityControlsList = objGetValuesXMLQualityControls.GetValuesXMLQualityControls(DKToSearch, PaxNumber, C1s, C2s, C3s, C4s, C5s, C6s, C7s, C8s, C9s, C10s,
