...
namespace VolarisPruebas
{
    class Program
    {
        static void Main(string[] args)
        {
            VolarisServiceManager avion = new VolarisServiceManager();
            avion.BookingRoundTripTest();
        }
    ...
    public class VolarisServiceManager
    {
        public void BookingRoundTripTest()
        {
            for (int a = 0; a < 100; a++)
            {
                ...
                System.IO.StreamWriter file = new System.IO.StreamWriter(@"c:\RESP\NuevaAplicacionBookingResponse " + tiempoInicio.ToString("yyyy_MM_dd_HH_mm_ss") + tiempoFin.ToString("yyyy_MM_dd_HH_mm_ss") + ".xml");
