...
-- =============================================
CREATE Procedure [dbo].[GetQCbyAttribute1_AD]
...
Begin
	...
	(Select DeleteAccountingLines,DeleteAccountingRemarks,CuotingActualFare,
			...
			ComparativeSpecificFare,ClassComparativeSpecific,
			ComparativeBusinessFare,ClassComparativeBusiness1,ClassComparativeBusiness2,
			ClassComparativeBusiness3,ClassComparativeBusiness4,
			...
			Cast(GetThereQCValues as varchar(3)) as GetThereQCValues,
