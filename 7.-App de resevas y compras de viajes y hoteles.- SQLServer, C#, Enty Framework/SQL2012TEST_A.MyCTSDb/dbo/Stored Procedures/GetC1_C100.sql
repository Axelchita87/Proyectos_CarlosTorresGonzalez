...
-- Create date: 23-07-2010, modified:*
-- Description:	Procedure that gets the QualityControls or Features 
--              for the controls of a Corporative
-- =============================================
CREATE Procedure [dbo].[GetC1_C100]
...
Begin
	...
	Select CtrlId,CtrlValue
		...
		(CtrlValue FOR CtrlId IN (C1,C2,C3,C4,C5,C6,C7,C8,C9,C10,C11,C12,C13,C14,C15,C16,C17,C18,C19,C20,
								  ...
								  C41,C42,C43,C44,C45,C46,C47,C48,C49,C50,C51,C52,C53,C54,C55,C56,C57,C58,C59,C60,
								  C61,C62,C63,C64,C65,C66,C67,C68,C69,C70,C71,C72,C73,C74,C75,C76,C77,C78,C79,C80,
								  C81,C82,C83,C84,C85,C86,C87,C88,C89,C90,C91,C92,C93,C94,C95,C96,C97,C98,C99,C100)) AS pvt

select QC.IdCtrl,LR.Description,QC.ValueCtrl
from #TempQC QC
LEFT JOIN dbo.LabelsRemarks LR on LR.IDRemarkLabel=QC.IdCtrl
where QC.ValueCtrl<>'I'
