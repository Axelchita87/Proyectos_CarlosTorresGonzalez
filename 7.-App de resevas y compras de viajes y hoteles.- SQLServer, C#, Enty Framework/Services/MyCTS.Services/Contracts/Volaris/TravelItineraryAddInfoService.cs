...
namespace MyCTS.Services.Contracts.Volaris
{
    ...
    /// 
    /// </summary>
    public class TravelItineraryAddInfoService : ISabreService
    {
        ...
        public void Call()
        {
            try
            {
                ...
                var service = new TravelItineraryAddInfoTest.TravelItineraryAddInfoService()
                                  {
            ...
            var customerInfo = new TravelItineraryAddInfoRQCustomerInfo()
                                   {
                                       ...
                                       Email = new[]
                                                   {
                                                       new TravelItineraryAddInfoRQCustomerInfoEmail()
                                                           {
                                                               Address = "rodrigofdz@gmail.com"
                                                           },
                                                       new TravelItineraryAddInfoRQCustomerInfoEmail()
                                                           {
                                                               Address = "rfernandez@ctsmex.com.mx"
                                                           }
                                                   }
                                   };
            return customerInfo;
