...
namespace AdminEvents.AccesoDatos
{
     class ConexionFTP
    {
        ...
        string server = ConfigurationManager.AppSettings["servFTP"],
                   path = ConfigurationManager.AppSettings["pathFTP"],
                   user = ConfigurationManager.AppSettings["userFTP"],
                   pwd = ConfigurationManager.AppSettings["pwdFTP"];
        int port = Convert.ToInt32(ConfigurationManager.AppSettings["portFTP"]);
        #endregion
