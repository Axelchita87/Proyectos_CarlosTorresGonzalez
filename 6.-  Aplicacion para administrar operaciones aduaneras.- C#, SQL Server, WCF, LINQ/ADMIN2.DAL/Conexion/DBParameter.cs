...
namespace ADMIN2.DAL
{
    public class DBParameter
    {
        ...
        bool SqlSrv = ConfigurationManager.ConnectionStrings["conxAdm"].ProviderName == "System.Data.SqlClient" ? true : false;
        #endregion
        ...
        public DBParameter(string name, object value)
       {
        ...
        public DBParameter(string name, object value, DbType dbType)
        {
            if (SqlSrv)
            {
                value = dbType == DbType.DateTime ? (Convert.ToDateTime(value) == DateTime.MinValue ? null : value) : value;
            }
